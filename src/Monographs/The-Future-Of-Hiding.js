    ...
    <main>
      <div className="publication-container">
        <div className="publication-upper">
          <img src="media/publications-imgs/1.jpg" alt="test" />
        ...
        <div className="publication-text mt-5">
          ...
          <p>
            ...
            its contribution to social order, and how concealment takes place in
            relation to energy infrastructure. The ethnography shows how shadow
            spaces connect the private and the social by furnishing a space for
            retreat, thus allowing opacity and diversity against the central
            gaze. The research highlights the way in which basements, garages,
            bunkers, and summer cottages operate as a surplus of living at the
            border with Russia, allowing local residents to redesign the very
            terms of their social being.
          </p>
          <p>
            Field research in this liminal region provides a dearth of
            information about political alterity, ecological memory,
            recolonization, and what does not disappear properly. Therefore,
            this book expands the space for locating culture, politics, and the
            reproduction and destruction of infrastructure, showing, in turn,
            alternative forms of sociality and various strategies, such as
            refusal and concealment, used by individuals to navigate
            sociopolitical change and the consequences of a century of
